// Titles: https://omdbapi.com/?s=thor&page=1&apikey=c326b05d
// details: http://www.omdbapi.com/?i=tt3896198&apikey=c326b05d
const API_KEY_TRAILERS = 'AIzaSyAXF_4runhSUjlBCAhV_EPQO7MGKzw_Dic'
...
async function loadMovies(searchTerm){
    const URL = `https://omdbapi.com/?s=${searchTerm}&page=1&apikey=c326b05d`;
...
function loadMovieDetails(){
    ...
    searchListMovies.forEach(movie => {
        movie.addEventListener('click', async () => {
            ...
            displayTrailers(movieDetails.Title)
        });
    });
}
